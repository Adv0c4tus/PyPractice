...
print('lines:', count_lines(file_handle))
print('letters:', count_letters(file_handle))
print('words:', count_words(file_handle))
print('max line length:', max_line_length(file_handle))
file_handle.close()
